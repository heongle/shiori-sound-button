...
class Soundboard {
  private:
    const static int btnCount = 42;
    const QString soundName[btnCount] = {
        "あっあっあっ", "あんあん～", "バーーーン", "カンカン．．．","くしゃみ 1", "くしゃみ 2", "くしゃみ 3", "くしゃみ 4",
        "くしゃみ 5", "くしゃみ 6", "くしゃみ 7", "くしゃみ 8", "くしゃみ 9", "くしゃみ 10", "くしゃみ 11", "起きろああ", "おにいーちゃん", "おにいちゃん",
        "おやすみなー", "おやすみなーさい", "おやすみなさい", "おっと", "晚安", "晚安～～", "わんわん～", "ユメノシオリだよ！", "ユメ入り", "ユメ入りいい",
        "ユメ堕つー", "ユメ堕つっ", "ユ～", "連打！", "フルコンボだドン", "Great!", "Excellent!", "Excellent 2", "あんあんーー", "えい！えい！えい！", "ひゃぁぁぁ", 
        "ねっ", "Shiori punch", "Shiori punch 2"
    };
